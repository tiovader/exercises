...
def add_me_with_my_friends(queue: list[str], index: int, person_name: str) -> list:
    '''
...
def remove_the_mean_person(queue: list[str], person_name: str) -> list:
    '''
